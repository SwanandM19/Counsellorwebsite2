...
//           {/* Right side */}
//           <div className="flex-none pr-0.5 sm:pr-1 z-10">
//             {/* Desktop CTA */}
//             <a 
//               href="#contact" 
//               className="codepen-button hidden md:inline-block touch-manipulation"
//             >
...
//               className="md:hidden flex flex-col gap-1.5 p-1.5 sm:p-2 touch-manipulation relative z-20"
