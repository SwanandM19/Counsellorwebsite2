...
export default function Home() {
    ...
    systemItems.forEach(item => {
      const handleMouseEnter = () => {
        ...
        systemItems.forEach(i => {
          ...
          if (i === item) {
            indicator?.classList.remove('bg-slate-300');
            indicator?.classList.add('bg-[#2FA5C4]');
            title?.classList.remove('text-slate-900');
            title?.classList.add('text-[#2FA5C4]');
          } else {
            indicator?.classList.add('bg-slate-300');
            indicator?.classList.remove('bg-[#2FA5C4]');
            title?.classList.add('text-slate-900');
            title?.classList.remove('text-[#2FA5C4]');
          }
        });
  ...
  return (
    <div className="scroll-smooth bg-[#FFFCF5] text-slate-900 selection:bg-[#FF6F59] selection:text-white relative">
      <LeadPopup />
      {/* Noise Overlay - Fixed */}
      <div className="fixed inset-0 pointer-events-none z-[9999] opacity-[0.03] mix-blend-multiply bg-noise" />
      ...
      <div className="fixed inset-0 z-0">
        {/* Gradient Background */}
        <div className="absolute inset-0 bg-gradient-to-b from-[#BFE6F5] via-[#EAF6E9] to-[#FFFCF5]" />
        ...
        <div className="hidden md:block absolute top-[22%] left-[8%] w-6 h-6 rounded-full bg-[#FFB627] opacity-70 animate-[float1_7s_ease-in-out_infinite]" />
        <div className="hidden md:block absolute top-[38%] right-[12%] w-4 h-4 rounded-full bg-[#4CAF6D] opacity-70 animate-[float2_6s_ease-in-out_infinite]" />
        <div className="hidden md:block absolute top-[12%] right-[30%] w-3 h-3 rounded-full bg-[#E63950] opacity-60 animate-[float1_8s_ease-in-out_infinite]" />
        <div className="hidden md:block absolute top-[55%] left-[20%] w-5 h-5 rounded-full bg-[#2FA5C4] opacity-60 animate-[float2_9s_ease-in-out_infinite]" />
      </div>
  ...
  <div className="w-full max-w-[90rem] mx-auto relative z-10 grid grid-cols-1 gap-12 items-center">
    <div className="flex flex-col items-center text-center mt-12 md:mt-0">
      <div className="inline-flex items-center gap-3 border-2 border-[#2FA5C4]/20 bg-white/70 backdrop-blur-md px-4 py-2 rounded-full mb-8 reveal-up shadow-sm is-visible" style={{ transitionDelay: '1.1s' }}>
        <div className="w-2 h-2 bg-[#FF6F59] rounded-full animate-pulse shadow-[0_0_10px_rgba(255,111,89,0.25)]" />
        <span className="font-mono text-xs font-semibold text-slate-700 uppercase tracking-widest">
          ✨ RCI Registered Psychologist
        </span>
      </div>

      {/* Brand Name - the real headline */}
      <h1 className="font-display font-bold text-[clamp(3.5rem,11vw,10.5rem)] leading-[0.85] tracking-tight mb-4 reveal-up text-balance is-visible" style={{ transitionDelay: '1.2s' }}>
        <span className="text-[#E63950]">Neuro</span>{' '}
        <span className="text-[#2FA5C4]">Nest</span>
      </h1>

      {/* Subtitle - what it is */}
      <div className="flex items-center justify-center gap-3 mb-8 reveal-up is-visible" style={{ transitionDelay: '1.25s' }}>
        <span className="w-8 h-[3px] rounded-full bg-[#FFB627]" />
        <span className="font-mono text-sm md:text-base font-bold text-slate-600 uppercase tracking-[0.25em]">
          Kids Counselling Center
        </span>
        <span className="w-8 h-[3px] rounded-full bg-[#4CAF6D]" />
      </div>

      {/* Tagline */}
      <p className="font-display font-bold text-[clamp(1.25rem,3vw,2rem)] leading-[1.3] mb-8 reveal-up text-balance is-visible flex flex-wrap items-center justify-center gap-x-3 gap-y-1" style={{ transitionDelay: '1.3s' }}>
        <span className="text-[#E63950]">Healing Minds.</span>
        <span className="text-[#4CAF6D]">Growing Hearts.</span>
        {/* <span className="inline-flex h-[clamp(2rem,4vw,3rem)] w-[clamp(4.5rem,9vw,7rem)] bg-white border-4 border-[#FFB627] rounded-full items-center justify-center overflow-hidden relative group backdrop-blur-sm shadow-md align-middle">
          <span className="bg-center group-hover:scale-110 transition-transform duration-1000 opacity-60 bg-[url(https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=320&q=80)] bg-cover absolute inset-0" />
          <span className="z-[5] absolute inset-0 bg-[#FFB627]/20" />
          <span className="text-[10px] text-white tracking-widest font-mono font-bold z-10 relative drop-shadow">
            HEARTS
          </span>
        </span> */}
        <span className="text-[#2FA5C4]">Empowering Lives.</span>
      </p>

      <p className="font-sans text-[clamp(1.125rem,1.5vw,1.5rem)] font-medium text-slate-600 max-w-[50ch] leading-[1.6] mb-12 reveal-up text-balance is-visible" style={{ transitionDelay: '1.35s' }}>
        Compassionate, Confidential Counseling for Children, Adolescents, Adults &amp; Families.
      </p>

      <div className="flex flex-col sm:flex-row items-center justify-center gap-6 w-full sm:w-auto reveal-up is-visible" style={{ transitionDelay: '1.4s' }}>
        <button onClick={openLeadPopup} className="codepen-button w-full sm:w-auto cursor-pointer">
          <span className="px-8 py-4 text-sm font-mono font-bold tracking-widest flex items-center gap-2">
            BOOK A FREE CONSULTATION
            {/* @ts-expect-error - web component */}
            <iconify-icon icon="solar:heart-linear" className="w-5 h-5" />
          </span>
        </button>
        <a href="#services" className="group flex items-center justify-center gap-3 h-14 px-6 text-xs text-slate-500 hover:text-[#2FA5C4] font-mono font-semibold tracking-widest transition-colors w-full sm:w-auto">
          <div className="w-8 h-[3px] rounded-full bg-slate-300 group-hover:w-12 group-hover:bg-[#2FA5C4] transition-all duration-300" />
          EXPLORE SERVICES
        </a>
      </div>
    </div>
  ...
  {/* Scroll Indicator */}
  <div className="absolute left-[clamp(1.5rem,5vw,5rem)] bottom-12 hidden lg:flex flex-col items-start gap-4 reveal-up is-visible" style={{ transitionDelay: '1.5s' }}>
    <div className="font-mono text-xs font-semibold text-slate-700 tracking-widest transform -rotate-90 origin-left translate-y-12">
      SCROLL
    </div>
    <div className="w-[3px] h-16 bg-slate-900/20 rounded-full relative overflow-hidden ml-2">
      <div className="absolute top-0 left-0 w-full h-1/2 bg-[#FF6F59] rounded-full animate-slideDown" />
    </div>
  </div>
</section>

        {/* Metrics - Now with semi-transparent background, each card its own rainbow color like the logo */}
        <section className="border-y-4 border-[#FFB627]/20 relative z-20 bg-white/80 backdrop-blur-sm">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-200 w-full">
            {[
              { label: 'YEARS EXPERIENCE', target: 15, suffix: '+', description: 'Dedicated to supporting children, adolescents, adults, and families.', color: '#E63950' },
              { label: 'CLIENTS HELPED', target: 850, suffix: '+', description: 'Individuals and families supported on their healing journey.', color: '#2FA5C4' },
              { label: 'EXPERTISE AREAS', target: 8, suffix: '+', description: 'Specialized in child counseling, ADHD, autism, learning difficulties & more.', color: '#4CAF6D' },
              { label: 'THERAPY MODALITIES', target: 5, suffix: '+', description: 'Remedial, ABA, Behaviour Therapy & evidence-based interventions.', color: '#FFB627' }
            ].map((metric, idx) => (
              <div key={idx} className="p-10 lg:p-14 flex flex-col justify-between aspect-square group bg-white/50 transition-colors duration-500 cursor-default relative overflow-hidden" style={{ ['--metric-color' as any]: metric.color }}>
                <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500" style={{ backgroundColor: metric.color }} />
                <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1462331940025-496dfbfc7564?q=80&w=800&auto=format&fit=crop')] bg-cover bg-center opacity-0 group-hover:opacity-10 transition-opacity duration-700 mix-blend-multiply grayscale" />
                <span className="group-hover:text-white/80 transition-colors z-10 text-xs font-bold text-slate-500 tracking-widest font-mono relative">
                  {metric.label}
                </span>
                <div className="relative z-10 transform group-hover:-translate-y-4 transition-transform duration-500">
                  <div className="text-[clamp(3.5rem,6vw,5.5rem)] leading-none group-hover:text-white transition-colors font-bold text-slate-900 tracking-tighter font-display mb-2">
                    <span className="count-up" data-target={metric.target}>0</span>
                    {metric.suffix}
                  </div>
                  <p className="group-hover:text-white/90 transition-colors text-sm font-medium text-slate-500">
                    {metric.description}
                  </p>
                </div>
              </div>
        ...
        <section id="services" className="py-[6rem] md:py-[10rem] px-[clamp(1.5rem,5vw,5rem)] relative z-10 bg-white/90 backdrop-blur-sm">
          <div className="max-w-[90rem] mx-auto">
            <div className="mb-12 md:mb-20 reveal-up is-visible">
              <span className="font-mono text-xs font-bold text-[#4CAF6D] tracking-[0.2em] uppercase flex items-center gap-3 mb-6">
                <span className="w-3 h-3 rounded-full bg-[#4CAF6D]" />
                Our Therapy Services
              </span>
              <h2 className="font-display font-bold text-[clamp(2.5rem,5vw,4.5rem)] tracking-tight leading-none mb-6 text-slate-900">
                Evidence-Based
                <br />
                <span className="text-[#2FA5C4]">Therapeutic Interventions.</span>
              </h2>
              <p className="text-[clamp(1.125rem,1.5vw,1.25rem)] font-medium text-slate-500 max-w-[45ch] leading-[1.6]">
                At Neuro Nest Counseling Center, we provide personalized, evidence-based therapeutic interventions tailored to each individual's unique needs.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4 auto-rows-auto md:auto-rows-[24rem]">
              {/* Main Featured Box - Remedial Therapy */}
              <div className="md:col-span-8 md:row-span-2 bg-white border-2 border-slate-100 relative overflow-hidden transition-all duration-700 group hover:border-[#E63950]/30 hover:shadow-[0_20px_40px_-20px_rgba(230,57,80,0.15)] flex flex-col justify-between reveal-up min-h-[24rem] bento-card hover:scale-[1.01] hover:z-20 rounded-[1.75rem] is-visible">
                <div className="absolute inset-0 z-0 overflow-hidden rounded-[1.75rem]">
                  <div className="absolute bottom-0 left-0 right-0 h-[65%] bg-gradient-to-t from-white via-white/70 to-transparent z-10 pointer-events-none" />
                  <img src="https://images.unsplash.com/photo-1503676260728-1c00da094a0b?q=80&w=1600&auto=format&fit=crop" alt="Remedial Therapy" className="w-full h-full object-cover saturate-[1.1] transition-all duration-[600ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-105 group-hover:brightness-[1.08] group-hover:contrast-[1.05]" />
                </div>
                <div className="z-10 relative h-full flex flex-col justify-between p-8 md:p-12 pointer-events-none">
                  <div className="flex justify-between items-start mb-12 md:mb-0">
                    <div className="font-mono text-xs font-bold bg-white/80 border-2 border-[#E63950]/20 px-3 py-1 rounded-full text-[#E63950] backdrop-blur-md">
                      THERAPY_01
                    </div>
                    {/* @ts-expect-error - web component */}
                    <iconify-icon icon="solar:book-linear" className="w-8 h-8 text-slate-900 opacity-40 group-hover:opacity-100 group-hover:text-[#E63950] transition-all duration-500 text-3xl" />
                  </div>
                  <div className="max-w-[32rem] pointer-events-auto">
                    <h3 className="font-display font-bold text-[clamp(2rem,3vw,3rem)] text-slate-900 mb-4 leading-none tracking-tight drop-shadow-sm group-hover:drop-shadow-none">
                      Remedial Therapy
                    </h3>
                    <p className="text-base font-medium text-slate-600 leading-[1.6] mb-8 group-hover:text-slate-800 transition-colors">
                      Designed for children who experience learning difficulties in reading, writing, spelling, mathematics, attention, or academic performance. Individualized teaching strategies to improve learning skills, confidence, and school performance.
                    </p>
                    <div className="flex flex-wrap gap-2 mb-6">
                      <span className="text-[10px] font-mono font-bold bg-[#E63950]/10 px-2 py-1 rounded-full text-[#E63950]">Learning Disabilities</span>
                      <span className="text-[10px] font-mono font-bold bg-[#E63950]/10 px-2 py-1 rounded-full text-[#E63950]">Reading & Writing</span>
                      <span className="text-[10px] font-mono font-bold bg-[#E63950]/10 px-2 py-1 rounded-full text-[#E63950]">Attention & Concentration</span>
                    </div>
                    <button onClick={openLeadPopup} className="inline-flex items-center gap-2 font-mono text-xs font-bold text-[#E63950] hover:text-[#c92e42] transition-colors cursor-pointer">
                      LEARN MORE
                      {/* @ts-expect-error - web component */}
                      <iconify-icon icon="solar:arrow-right-linear" className="w-4 h-4" />
                    </button>
              ...
              {/* ABA Therapy */}
              <div className="md:col-span-4 md:row-span-2 bg-white border-2 border-slate-100 relative overflow-hidden transition-all duration-700 group hover:border-[#2FA5C4]/30 hover:shadow-[0_20px_40px_-20px_rgba(47,165,196,0.15)] flex flex-col justify-between reveal-up min-h-[24rem] bento-card hover:scale-[1.01] hover:z-20 rounded-[1.75rem] is-visible" style={{ transitionDelay: '0.1s' }}>
                <div className="absolute inset-0 z-0 overflow-hidden rounded-[1.75rem]">
                  <div className="absolute bottom-0 left-0 right-0 h-[65%] bg-gradient-to-t from-white via-white/70 to-transparent z-10 pointer-events-none" />
                  <img src="https://images.unsplash.com/photo-1582213782179-e0d53f98f2ca?q=80&w=1600&auto=format&fit=crop" alt="ABA Therapy" className="w-full h-full object-cover contrast-[1.08] saturate-[1.05] transition-all duration-[600ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-105 group-hover:brightness-[1.08] group-hover:contrast-[1.05]" />
                </div>
                <div className="z-10 relative h-full flex flex-col justify-between p-8 md:p-12 pointer-events-none">
                  <div className="flex justify-between items-start mb-8 md:mb-12">
                    <div className="font-mono text-xs font-bold bg-white/80 border-2 border-[#2FA5C4]/20 px-3 py-1 rounded-full text-[#2FA5C4] backdrop-blur-md">
                      THERAPY_02
                    </div>
                  </div>
                  <div className="pointer-events-auto">
                    <h3 className="font-display font-bold text-[clamp(1.5rem,2.5vw,2rem)] text-slate-900 mb-3 tracking-tight">
                      ABA Therapy
                    </h3>
                    <p className="text-base font-medium text-slate-600 leading-relaxed mb-4 group-hover:text-slate-800 transition-colors">
                      Structured, evidence-based intervention that helps children develop positive behaviours, communication, social interaction, and independence through positive reinforcement.
                    </p>
                    <div className="flex flex-wrap gap-2 mb-4">
                      <span className="text-[10px] font-mono font-bold bg-[#2FA5C4]/10 px-2 py-1 rounded-full text-[#2FA5C4]">Autism Spectrum</span>
                      <span className="text-[10px] font-mono font-bold bg-[#2FA5C4]/10 px-2 py-1 rounded-full text-[#2FA5C4]">Developmental Delays</span>
                    </div>
                    <button onClick={openLeadPopup} className="inline-flex items-center gap-2 font-mono text-xs font-bold text-[#2FA5C4] hover:text-[#25839e] transition-colors cursor-pointer">
                      LEARN MORE
                      {/* @ts-expect-error - web component */}
                      <iconify-icon icon="solar:arrow-right-linear" className="w-4 h-4" />
                    </button>
              ...
              {/* Behaviour Therapy - Wide Box */}
              <div className="md:col-span-12 bg-white border-2 border-slate-100 relative overflow-hidden transition-all duration-700 group hover:border-[#4CAF6D]/30 hover:shadow-[0_20px_40px_-20px_rgba(76,175,109,0.15)] flex flex-col md:flex-row reveal-up bento-card hover:scale-[1.01] hover:z-20 rounded-[1.75rem] is-visible" style={{ transitionDelay: '0.2s' }}>
                <div className="absolute inset-0 z-0 overflow-hidden rounded-[1.75rem]">
                  <div className="absolute inset-0 bg-gradient-to-t from-white via-white/70 to-transparent md:bg-gradient-to-r md:from-white md:via-white/70 md:to-transparent z-10 pointer-events-none" />
                  <img src="https://images.unsplash.com/photo-1544367567-0f2fcb009e0b?q=80&w=1600&auto=format&fit=crop" alt="Behaviour Therapy" className="contrast-[1.05] saturate-[1.05] transition-all duration-[600ms] ease-[cubic-bezier(0.16,1,0.3,1)] group-hover:scale-105 group-hover:brightness-[1.08] group-hover:contrast-[1.05] w-full h-full object-cover" />
                </div>
                <div className="p-8 md:p-12 flex-1 flex flex-col justify-center z-10 relative w-full pointer-events-none">
                  <div className="font-mono text-xs font-bold bg-white/80 border-2 border-[#4CAF6D]/20 px-3 py-1 rounded-full text-[#4CAF6D] self-start mb-6 backdrop-blur-md">
                    THERAPY_03
                  </div>
                  <h3 className="font-display font-bold text-[clamp(1.75rem,2.5vw,2.25rem)] text-slate-900 mb-4 tracking-tight">
                    Behaviour Therapy
                  </h3>
                  <p className="text-base font-medium text-slate-600 leading-[1.6] max-w-[40ch] mb-4 group-hover:text-slate-800 transition-colors">
                    Helps individuals understand and change behaviours that affect their daily functioning. Focuses on building healthy habits, improving emotional regulation, increasing self-control, and developing effective coping skills.
                  </p>
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="text-[10px] font-mono font-bold bg-[#4CAF6D]/10 px-2 py-1 rounded-full text-[#4CAF6D]">Anger Management</span>
                    <span className="text-[10px] font-mono font-bold bg-[#4CAF6D]/10 px-2 py-1 rounded-full text-[#4CAF6D]">Anxiety & Stress</span>
                    <span className="text-[10px] font-mono font-bold bg-[#4CAF6D]/10 px-2 py-1 rounded-full text-[#4CAF6D]">ADHD</span>
                    <span className="text-[10px] font-mono font-bold bg-[#4CAF6D]/10 px-2 py-1 rounded-full text-[#4CAF6D]">Emotional Regulation</span>
                  </div>
                  <button onClick={openLeadPopup} className="inline-flex items-center gap-2 font-mono text-xs font-bold text-[#4CAF6D] hover:text-[#3a8c56] transition-colors pointer-events-auto cursor-pointer">
                    LEARN MORE
                    {/* @ts-expect-error - web component */}
                    <iconify-icon icon="solar:arrow-right-linear" className="w-4 h-4" />
                  </button>
        ...
        <section id="how-it-works" className="py-[6rem] md:py-[10rem] px-[clamp(1.5rem,5vw,5rem)] relative z-10">
          <div className="max-w-[90rem] mx-auto">
            {/* Section Header */}
            <div className="text-center mb-16 md:mb-20 reveal-up">
              <div className="inline-flex items-center gap-3 border-2 border-[#FFB627]/20 bg-white/50 backdrop-blur-md px-4 py-2 rounded-full mb-6">
                <div className="w-2 h-2 bg-[#FFB627] rounded-full animate-pulse" />
                <span className="font-mono text-xs font-bold text-slate-700 uppercase tracking-widest">
                  How It Works
                </span>
              </div>
              <h2 className="font-display font-bold text-[clamp(2.5rem,5vw,4.5rem)] tracking-tight leading-[1.1] mb-4 text-slate-900">
                Your Healing Journey.
                <br />
                <span className="text-[#FFB627]">Three Simple Steps.</span>
              </h2>
              <p className="text-[clamp(1rem,1.5vw,1.125rem)] font-medium text-slate-500 max-w-[60ch] mx-auto leading-[1.6]">
                Starting therapy can feel daunting, but we've made the process simple
                and welcoming — so you can focus on what matters most: your wellbeing.
              </p>
            </div>
            ...
            {/* Main Glass Container */}
            <div className="relative rounded-[2.5rem] bg-white/30 backdrop-blur-xl border-2 border-white/40 shadow-2xl overflow-hidden reveal-up">
              <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-transparent to-white/5 pointer-events-none" />
              <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#E63950]/10 rounded-full blur-3xl" />
              <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#2FA5C4]/10 rounded-full blur-3xl" />
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 relative p-8 md:p-12">
                ...
                {/* Step 1 */}
                <div className="relative group reveal-up" style={{ transitionDelay: '0.1s' }}>
                  <div className="bg-white/50 backdrop-blur-md border-2 border-white/60 rounded-[1.75rem] p-8 md:p-10 hover:border-[#E63950]/40 hover:bg-white/60 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden shadow-lg">
                    <div className="absolute inset-0 bg-gradient-to-br from-white/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                    <div className="flex items-center justify-between mb-6">
                      <div className="text-7xl md:text-8xl font-display font-bold text-[#E63950]/15 group-hover:text-[#E63950]/25 transition-colors duration-500">
                        01
                      </div>
                      <div className="w-12 h-12 rounded-full bg-[#E63950]/15 backdrop-blur-sm flex items-center justify-center group-hover:bg-[#E63950] transition-all duration-500 group-hover:scale-110 border-2 border-white/50">
                        <svg className="w-6 h-6 text-[#E63950] group-hover:text-white transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                        </svg>
                      </div>
                    </div>
                    <h3 className="text-2xl md:text-3xl font-display font-bold text-slate-900 mb-3 tracking-tight">
                      Book Your
                      <br />
                      Free Consultation
                    </h3>
                    ...
                    <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#E63950]">
                      <span className="bg-[#E63950]/10 px-2 py-1 rounded-full">STEP 1</span>
                    </div>
                  </div>
                  <div className="flex flex-wrap gap-2 mt-4 px-2">
                    <span className="text-[10px] font-mono font-semibold text-slate-500/70 uppercase tracking-wider">Completely confidential</span>
                    <span className="text-[10px] font-mono text-slate-500/70 uppercase tracking-wider">•</span>
                    <span className="text-[10px] font-mono font-semibold text-slate-500/70 uppercase tracking-wider">No pressure</span>
                  </div>
                </div>

                {/* Step 2 */}
                <div className="relative group reveal-up" style={{ transitionDelay: '0.2s' }}>
                  <div className="bg-white/50 backdrop-blur-md border-2 border-white/60 rounded-[1.75rem] p-8 md:p-10 hover:border-[#2FA5C4]/40 hover:bg-white/60 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden shadow-lg">
                    <div className="absolute inset-0 bg-gradient-to-br from-white/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                    <div className="flex items-center justify-between mb-6">
                      <div className="text-7xl md:text-8xl font-display font-bold text-[#2FA5C4]/15 group-hover:text-[#2FA5C4]/25 transition-colors duration-500">
                        02
                      </div>
                      <div className="w-12 h-12 rounded-full bg-[#2FA5C4]/15 backdrop-blur-sm flex items-center justify-center group-hover:bg-[#2FA5C4] transition-all duration-500 group-hover:scale-110 border-2 border-white/50">
                        <svg className="w-6 h-6 text-[#2FA5C4] group-hover:text-white transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" />
                        </svg>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#2FA5C4]">
                      <span className="bg-[#2FA5C4]/10 px-2 py-1 rounded-full">STEP 2</span>
                    </div>
                  </div>
                  <div className="flex flex-wrap gap-2 mt-4 px-2">
                    <span className="text-[10px] font-mono font-semibold text-slate-500/70 uppercase tracking-wider">Flexible scheduling</span>
                    <span className="text-[10px] font-mono text-slate-500/70 uppercase tracking-wider">•</span>
                    <span className="text-[10px] font-mono font-semibold text-slate-500/70 uppercase tracking-wider">In-person & online</span>
                  </div>
                </div>

                {/* Step 3 */}
                <div className="relative group reveal-up" style={{ transitionDelay: '0.3s' }}>
                  <div className="bg-white/50 backdrop-blur-md border-2 border-white/60 rounded-[1.75rem] p-8 md:p-10 hover:border-[#4CAF6D]/40 hover:bg-white/60 transition-all duration-500 hover:-translate-y-2 relative overflow-hidden shadow-lg">
                    <div className="absolute inset-0 bg-gradient-to-br from-white/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
                    <div className="flex items-center justify-between mb-6">
                      <div className="text-7xl md:text-8xl font-display font-bold text-[#4CAF6D]/15 group-hover:text-[#4CAF6D]/25 transition-colors duration-500">
                        03
                      </div>
                      <div className="w-12 h-12 rounded-full bg-[#4CAF6D]/15 backdrop-blur-sm flex items-center justify-center group-hover:bg-[#4CAF6D] transition-all duration-500 group-hover:scale-110 border-2 border-white/50">
                        <svg className="w-6 h-6 text-[#4CAF6D] group-hover:text-white transition-colors duration-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14 10l-2 1m0 0l-2-1m2 1v2.5M20 7l-2 1m2-1l-2-1m2 1v2.5M14 4l-2-1-2 1M4 7l2-1M4 7l2 1M4 7v2.5M12 21l-2-1m2 1l2-1m-2 1v-2.5M6 18l-2-1v-2.5M18 18l2-1v-2.5" />
                        </svg>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2 text-xs font-mono font-bold text-[#4CAF6D]">
                      <span className="bg-[#4CAF6D]/10 px-2 py-1 rounded-full">STEP 3</span>
                    </div>
                  </div>
                  <div className="flex flex-wrap gap-2 mt-4 px-2">
                    <span className="text-[10px] font-mono font-semibold text-slate-500/70 uppercase tracking-wider">Ongoing support</span>
                    <span className="text-[10px] font-mono text-slate-500/70 uppercase tracking-wider">•</span>
                    <span className="text-[10px] font-mono font-semibold text-slate-500/70 uppercase tracking-wider">Proven methods</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Bottom CTA Link */}
            <div className="text-center mt-12 reveal-up" style={{ transitionDelay: '0.4s' }}>
              <button onClick={openLeadPopup} className="group inline-flex items-center gap-3 text-sm font-mono font-bold tracking-wider text-slate-600 hover:text-[#FF6F59] transition-colors cursor-pointer">
                <span className="w-8 h-[3px] rounded-full bg-slate-300 group-hover:w-12 group-hover:bg-[#FF6F59] transition-all duration-300" />
                START YOUR HEALING TODAY
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
        ...
        <section id="about" className="py-[6rem] md:py-[10rem] px-[clamp(1.5rem,5vw,5rem)] relative z-10">
          <div className="max-w-[90rem] mx-auto">
            {/* Section Header */}
            <div className="text-center mb-16 md:mb-20 reveal-up">
              <div className="inline-flex items-center gap-3 border-2 border-[#FF6F59]/20 bg-white/50 backdrop-blur-md px-4 py-2 rounded-full mb-6">
                <div className="w-2 h-2 bg-[#FF6F59] rounded-full animate-pulse" />
                <span className="font-mono text-xs font-bold text-slate-700 uppercase tracking-widest">
                  Meet Your Psychologist
                </span>
              </div>
              <h2 className="font-display font-bold text-[clamp(2.5rem,5vw,4.5rem)] tracking-tight leading-[1.1] mb-4 text-slate-900">
                Compassion You Can
                <br />
                <span className="text-[#FF6F59]">Trust With Your Story.</span>
              </h2>
              <p className="text-[clamp(1rem,1.5vw,1.125rem)] font-medium text-slate-500 max-w-[60ch] mx-auto leading-[1.6]">
                Work with an RCI Registered Psychologist who genuinely cares about your progress
                and is dedicated to helping you live a healthier, more fulfilling life.
            ...
            <div className="relative rounded-[2.5rem] bg-white/30 backdrop-blur-xl border-2 border-white/40 shadow-2xl overflow-hidden reveal-up">
              <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-transparent to-white/5 pointer-events-none" />
              <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#FF6F59]/10 rounded-full blur-3xl" />
              <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#2FA5C4]/10 rounded-full blur-3xl" />
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 relative p-8 md:p-12">
                {/* Image Section */}
                <div className="relative group">
                  <div className="absolute inset-0 bg-gradient-to-br from-[#FF6F59]/20 to-transparent rounded-[1.75rem] blur-2xl group-hover:blur-3xl transition-all duration-700" />
                  <div className="relative rounded-[1.75rem] overflow-hidden border-2 border-white/50 bg-white/30 backdrop-blur-sm shadow-xl">
                    <img
                      src="/counsellor.png"
                      alt="Rama Amte - RCI Registered Psychologist"
                      className="w-full h-full object-cover aspect-[4/5] grayscale-[0.2] hover:grayscale-0 transition-all duration-700 scale-100 hover:scale-105"
                    />
                    {/* Badge */}
                    <div className="absolute bottom-6 left-6 bg-white/90 backdrop-blur-md border-2 border-white rounded-full px-4 py-2">
                      <div className="flex items-center gap-2">
                        <div className="w-2 h-2 bg-[#FF6F59] rounded-full animate-pulse" />
                ...
                <div className="flex flex-col justify-center space-y-6">
                  <div className="reveal-up">
                    <h3 className="text-4xl md:text-5xl font-display font-bold text-slate-900 mb-3 tracking-tight">
                      Rama Amte
                    </h3>
                    <div className="flex flex-wrap gap-2 mb-3">
                      <div className="inline-flex items-center gap-2 bg-[#E63950]/10 backdrop-blur-sm px-3 py-1 rounded-full border-2 border-[#E63950]/20">
                        <span className="w-1.5 h-1.5 bg-[#E63950] rounded-full" />
                        <span className="text-xs font-mono font-bold text-[#E63950] tracking-wider">M.A. Psychology</span>
                      </div>
                      <div className="inline-flex items-center gap-2 bg-[#2FA5C4]/10 backdrop-blur-sm px-3 py-1 rounded-full border-2 border-[#2FA5C4]/20">
                        <span className="w-1.5 h-1.5 bg-[#2FA5C4] rounded-full" />
                        <span className="text-xs font-mono font-bold text-[#2FA5C4] tracking-wider">B.Ed. (Special Education)</span>
                      </div>
                      <div className="inline-flex items-center gap-2 bg-[#4CAF6D]/10 backdrop-blur-sm px-3 py-1 rounded-full border-2 border-[#4CAF6D]/20">
                        <span className="w-1.5 h-1.5 bg-[#4CAF6D] rounded-full" />
                        <span className="text-xs font-mono font-bold text-[#4CAF6D] tracking-wider">RCI Registered Psychologist</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Expertise Areas */}
                  <div className="reveal-up" style={{ transitionDelay: '0.2s' }}>
                    <h4 className="text-sm font-bold text-slate-900 mb-3">Areas of Expertise:</h4>
                    <div className="flex flex-wrap gap-2">
                      {[
                        { item: 'Child & Adolescent Counseling', color: '#E63950' },
                        { item: 'Behaviour Management', color: '#2FA5C4' },
                        { item: 'Learning Difficulties', color: '#4CAF6D' },
                        { item: 'ADHD & Autism', color: '#FFB627' },
                        { item: 'Parent Guidance', color: '#E63950' },
                        { item: 'Emotional Well-being', color: '#2FA5C4' },
                        { item: 'School Counseling', color: '#4CAF6D' },
                        { item: 'Psychoeducational Assessment', color: '#FFB627' }
                      ].map(({ item, color }) => (
                        <span key={item} className="text-[10px] font-mono font-bold px-2 py-1 rounded-full" style={{ backgroundColor: `${color}1A`, color }}>
                          {item}
                        </span>
                      ))}
                    </div>
                  ...
                  {/* Credentials Grid */}
                  <div className="grid grid-cols-2 gap-4 pt-4 reveal-up" style={{ transitionDelay: '0.3s' }}>
                    <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-4 border-2 border-white/40">
                      <div className="text-2xl font-display font-bold text-[#E63950] mb-1">15+</div>
                      <div className="text-xs font-mono font-semibold text-slate-500 uppercase tracking-wider">Years Experience</div>
                    </div>
                    <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-4 border-2 border-white/40">
                      <div className="text-2xl font-display font-bold text-[#2FA5C4] mb-1">3</div>
                      <div className="text-xs font-mono font-semibold text-slate-500 uppercase tracking-wider">Specializations</div>
                    </div>
                    <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-4 border-2 border-white/40">
                      <div className="text-2xl font-display font-bold text-[#4CAF6D] mb-1">RCI</div>
                      <div className="text-xs font-mono font-semibold text-slate-500 uppercase tracking-wider">Registered</div>
                    </div>
                    <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-4 border-2 border-white/40">
                      <div className="text-2xl font-display font-bold text-[#FFB627] mb-1">850+</div>
                      <div className="text-xs font-mono font-semibold text-slate-500 uppercase tracking-wider">Clients Helped</div>
                    </div>
                  </div>

                  {/* CRR Number */}
                  <div className="reveal-up bg-[#FF6F59]/5 rounded-2xl border-2 border-[#FF6F59]/15 p-3 flex items-center justify-center gap-3" style={{ transitionDelay: '0.35s' }}>
                    <div className="w-1.5 h-1.5 bg-[#FF6F59] rounded-full" />
                    <span className="text-xs font-mono text-slate-700 tracking-wider">
                      <span className="font-bold text-[#FF6F59]">CRR No.</span> A88242
                    </span>
                    <div className="w-1.5 h-1.5 bg-[#FF6F59] rounded-full" />
                  </div>

                  {/* Mission Statement */}
                  <div className="reveal-up p-4 bg-[#FFB627]/10 rounded-2xl border-2 border-[#FFB627]/20" style={{ transitionDelay: '0.4s' }}>
        ...
        <section id="testimonials" className="py-[6rem] md:py-[10rem] px-[clamp(1.5rem,5vw,5rem)] relative z-10 bg-white/80 backdrop-blur-sm overflow-hidden">
          <div className="max-w-[90rem] mx-auto relative z-10">
            ...
            {/* Header */}
            <div className="text-center mb-16 md:mb-20 reveal-up">
              <div className="inline-flex items-center gap-3 border-2 border-[#2FA5C4]/20 bg-white/50 backdrop-blur-md px-4 py-2 rounded-full mb-6">
                <div className="w-2 h-2 bg-[#2FA5C4] rounded-full animate-pulse"></div>
                <span className="font-mono text-xs font-bold text-slate-700 uppercase tracking-widest">Client Stories</span>
              </div>
              <h2 className="font-display font-bold text-[clamp(2.5rem,5vw,4.5rem)] tracking-tight leading-[1.1] mb-4 text-slate-900">
                Voices of Our <br />
                <span className="text-[#2FA5C4]">Healing Community.</span>
              </h2>
              <p className="text-[clamp(1rem,1.5vw,1.125rem)] font-medium text-slate-500 max-w-[60ch] mx-auto leading-[1.6]">
                Real moments shared by our clients and their counsellors on the path to healing.
              </p>
            ...
            <div className="relative rounded-[2.5rem] bg-white/30 backdrop-blur-xl border-2 border-white/40 shadow-2xl overflow-hidden reveal-up">
              <div className="absolute inset-0 bg-gradient-to-br from-white/30 via-transparent to-white/5 pointer-events-none"></div>
              <div className="absolute -top-40 -right-40 w-80 h-80 bg-[#2FA5C4]/10 rounded-full blur-3xl"></div>
              <div className="absolute -bottom-40 -left-40 w-80 h-80 bg-[#4CAF6D]/10 rounded-full blur-3xl"></div>

              {/* Scroll window */}
              <div className="relative h-[620px] overflow-hidden">
                {/* Top fade */}
                <div className="absolute top-0 left-0 right-0 h-24 bg-gradient-to-b from-white/80 via-white/40 to-transparent z-20 pointer-events-none rounded-t-[2.5rem]"></div>
                {/* Bottom fade */}
                <div className="absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-white/80 via-white/40 to-transparent z-20 pointer-events-none rounded-b-[2.5rem]"></div>

                {/* ── COLUMN 1 ── scrolls up */}
                <div className="community-col absolute left-0 top-0 w-full md:w-1/3 px-3 h-full">
                  <div className="community-track flex flex-col gap-3">
                    <div className="rounded-[1.5rem] overflow-hidden shadow-md flex-shrink-0" style={{ height: '260px' }}>
                      <img src="/community/photos/photo-01.jpg" alt="Healing community" className="w-full h-full object-cover" loading="lazy" />
                    </div>
                    <div className="rounded-[1.5rem] overflow-hidden shadow-md flex-shrink-0" style={{ height: '200px' }}>
                      <img src="/community/photos/photo-02.jpg" alt="Healing community" className="w-full h-full object-cover" loading="lazy" />
                    </div>
                    <div className="rounded-[1.5rem] overflow-hidden shadow-md flex-shrink-0" style={{ height: '240px' }}>
                      <img src="/community/photos/photo-03.jpg" alt="Healing community" className="w-full h-full object-cover" loading="lazy" />
                    </div>
                    <div className="rounded-[1.5rem] overflow-hidden shadow-md flex-shrink-0" style={{ height: '220px' }}>
                      <img src="/community/photos/photo-04.jpg" alt="Healing community" className="w-full h-full object-cover" loading="lazy" />
                    </div>
                    <div className="rounded-[1.5rem] overflow-hidden shadow-md flex-shrink-0" style={{ height: '260px' }}>
                      <img src="/community/photos/photo-05.jpg" alt="Healing community" className="w-full h-full object-cover" loading="lazy" />
            ...
            {/* CTA */}
            <div className="text-center mt-12 reveal-up" style={{ transitionDelay: '0.4s' }}>
              <button onClick={openLeadPopup} className="group inline-flex items-center gap-3 text-sm font-mono font-bold tracking-wider text-slate-600 hover:text-[#2FA5C4] transition-colors cursor-pointer">
                <span className="w-8 h-[3px] rounded-full bg-slate-300 group-hover:w-12 group-hover:bg-[#2FA5C4] transition-all duration-300"></span>
                BOOK YOUR HEALING SESSION
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
        ...
        <section id="blog" className="py-[6rem] md:py-[10rem] px-[clamp(1.5rem,5vw,5rem)] relative z-10 bg-white/80 backdrop-blur-sm">
          <div className="max-w-[90rem] mx-auto">
            {/* Section Header */}
            <div className="text-center mb-16 md:mb-20 reveal-up">
              <div className="inline-flex items-center gap-3 border-2 border-[#4CAF6D]/20 bg-white/50 backdrop-blur-md px-4 py-2 rounded-full mb-6">
                <div className="w-2 h-2 bg-[#4CAF6D] rounded-full animate-pulse" />
                <span className="font-mono text-xs font-bold text-slate-700 uppercase tracking-widest">
                  Latest Articles
                </span>
              </div>
              <h2 className="font-display font-bold text-[clamp(2.5rem,5vw,4.5rem)] tracking-tight leading-[1.1] mb-4 text-slate-900">
                Insights From the
                <br />
                <span className="text-[#4CAF6D]">Counselling Room.</span>
              </h2>
              <p className="text-[clamp(1rem,1.5vw,1.125rem)] font-medium text-slate-500 max-w-[60ch] mx-auto leading-[1.6]">
                Expert guidance, mental health tips, and stories of hope to support
                you on your wellbeing journey.
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 reveal-up">
              {/* Blog Post 1 */}
              <a href="/blog/how-creative-agencies-shape-the-future" className="group block">
                <div className="bg-white/60 backdrop-blur-md border-2 border-white/50 rounded-[1.75rem] overflow-hidden transition-all duration-500 hover:border-[#E63950]/40 hover:bg-white/70 hover:shadow-2xl hover:-translate-y-2">
                  {/* Image */}
                  <div className="relative h-56 overflow-hidden">
                    <img
                      src="https://images.unsplash.com/photo-1499209974431-9dddcece7f88?q=80&w=800&auto=format&fit=crop"
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <div className="absolute top-4 left-4 bg-[#E63950]/90 backdrop-blur-sm px-3 py-1 rounded-full">
                      <span className="text-white text-xs font-mono font-bold tracking-wider">ANXIETY</span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 md:p-8">
                    ...
                    <h3 className="text-xl md:text-2xl font-display font-bold text-slate-900 mb-3 tracking-tight group-hover:text-[#E63950] transition-colors duration-300">
                      Understanding Anxiety: What Your Body Is Trying to Tell You
                    </h3>
                    ...
                    <button onClick={openLeadPopup} className="flex items-center gap-2 text-sm font-mono font-bold text-[#E63950] group-hover:gap-3 transition-all duration-300 cursor-pointer">
                      READ MORE
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                      </svg>
              ...
              {/* Blog Post 2 */}
              <a href="/blog/the-real-roi-of-smart-design" className="group block">
                <div className="bg-white/60 backdrop-blur-md border-2 border-white/50 rounded-[1.75rem] overflow-hidden transition-all duration-500 hover:border-[#2FA5C4]/40 hover:bg-white/70 hover:shadow-2xl hover:-translate-y-2">
                  <div className="relative h-56 overflow-hidden">
                    <img
                      src="https://images.unsplash.com/photo-1516401266446-6432a8a07d41?q=80&w=800&auto=format&fit=crop"
                      alt="The Benefits of Couples Counselling"
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <div className="absolute top-4 left-4 bg-[#2FA5C4]/90 backdrop-blur-sm px-3 py-1 rounded-full">
                      <span className="text-white text-xs font-mono font-bold tracking-wider">RELATIONSHIPS</span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 md:p-8">
                    ...
                    <h3 className="text-xl md:text-2xl font-display font-bold text-slate-900 mb-3 tracking-tight group-hover:text-[#2FA5C4] transition-colors duration-300">
                      Why Couples Counselling Works — Even When It Feels Too Late
                    </h3>
                    <p className="text-slate-600 font-medium leading-relaxed mb-4">
                      Many couples wait until a breaking point to seek help. Here's why
                    ...
                    <button onClick={openLeadPopup} className="flex items-center gap-2 text-sm font-mono font-bold text-[#2FA5C4] group-hover:gap-3 transition-all duration-300 cursor-pointer">
                      READ MORE
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                      </svg>
              ...
              {/* Blog Post 3 */}
              <a href="/blog/how-purpose-driven-creativity-builds-brand-power" className="group block">
                <div className="bg-white/60 backdrop-blur-md border-2 border-white/50 rounded-[1.75rem] overflow-hidden transition-all duration-500 hover:border-[#4CAF6D]/40 hover:bg-white/70 hover:shadow-2xl hover:-translate-y-2">
                  <div className="relative h-56 overflow-hidden">
                    <img
                      src="https://images.unsplash.com/photo-1506126613408-eca07ce68773?q=80&w=800&auto=format&fit=crop"
                      alt="Mindfulness and Mental Health"
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/50 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    <div className="absolute top-4 left-4 bg-[#4CAF6D]/90 backdrop-blur-sm px-3 py-1 rounded-full">
                      <span className="text-white text-xs font-mono font-bold tracking-wider">MINDFULNESS</span>
                    </div>
                  </div>
                  ...
                  <div className="p-6 md:p-8">
                    ...
                    <h3 className="text-xl md:text-2xl font-display font-bold text-slate-900 mb-3 tracking-tight group-hover:text-[#4CAF6D] transition-colors duration-300">
                      5 Mindfulness Practices That Support Your Mental Health Daily
                    </h3>
                    <p className="text-slate-600 font-medium leading-relaxed mb-4">
                      Small daily habits can make a profound difference. Discover five
                    ...
                    <button onClick={openLeadPopup} className="flex items-center gap-2 text-sm font-mono font-bold text-[#4CAF6D] group-hover:gap-3 transition-all duration-300 cursor-pointer">
                      READ MORE
                      <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                      </svg>
            ...
            {/* View All Articles Link */}
            <div className="text-center mt-12 reveal-up" style={{ transitionDelay: '0.2s' }}>
              <a href="/blog" className="group inline-flex items-center gap-3 text-sm font-mono font-bold tracking-wider text-slate-600 hover:text-[#4CAF6D] transition-colors">
                <span className="w-8 h-[3px] rounded-full bg-slate-300 group-hover:w-12 group-hover:bg-[#4CAF6D] transition-all duration-300" />
                VIEW ALL ARTICLES
                <svg className="w-4 h-4 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
        ...
        {/* Final CTA - With Left-Aligned Content & Gradient Overlay */}
        <div className="relative z-20 px-[clamp(1.5rem,5vw,5rem)] py-[4rem] md:py-[8rem] bg-white/50 backdrop-blur-sm">
          <section className="cta-section relative w-full max-w-[90rem] mx-auto min-h-[55vh] flex flex-col md:flex-row items-center justify-between overflow-hidden rounded-[2.5rem] shadow-2xl">

            {/* Background Image */}
            <div
              className="absolute inset-0 z-0 bg-cover bg-center bg-no-repeat rounded-[2.5rem]"
              style={{ backgroundImage: "url('/bg.png')" }}
            />

            {/* Gradient Overlay - Dark on left, transparent on right */}
            <div className="absolute inset-0 z-10 bg-gradient-to-r from-black/85 via-black/60 to-black/20 rounded-[2.5rem]" />

            {/* Accent gradient from brand color */}
            <div className="absolute inset-0 z-10 bg-gradient-to-br from-[#FF6F59]/10 via-transparent to-[#2FA5C4]/5 rounded-[2.5rem]" />

            {/* Content - Left Aligned */}
            <div className="relative z-30 w-full max-w-[55rem] px-8 md:px-12 lg:px-16 py-16 md:py-20">

              {/* Animated Badge */}
              <div className="inline-flex items-center gap-3 bg-white/10 backdrop-blur-md border-2 border-white/20 px-4 py-2 rounded-full mb-6 animate-pulse">
                <div className="w-2 h-2 bg-[#FFB627] rounded-full animate-pulse" />
              ...
              {/* Main Heading */}
              <h2 className="font-display font-bold text-[clamp(2.5rem,5vw,5.5rem)] tracking-tight text-white leading-[1.05] mb-6">
                Ready to
                <span className="relative inline-block ml-2 md:ml-4">
                  <span className="text-[#FFB627]">Feel Better?</span>
                  <svg className="absolute -bottom-2 left-0 w-full h-[3px] text-[#FFB627]" viewBox="0 0 200 4" fill="currentColor">
                    <path d="M0,2 L200,2" stroke="currentColor" strokeWidth="2" strokeDasharray="4 4" />
                  </svg>
                </span>
              </h2>

              <p className="font-sans text-[clamp(1rem,1.25vw,1.125rem)] font-medium text-white/90 max-w-[45ch] mb-8 md:mb-10 leading-relaxed">
                Book a free consultation or schedule your first session. Our team
                responds within 24 hours. Completely confidential, zero obligations.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-5">
                <button
                  onClick={openLeadPopup}
                  className="group relative inline-flex items-center justify-center px-8 py-4 bg-[#FF6F59] text-white text-sm font-bold tracking-widest uppercase rounded-full transition-all duration-300 hover:-translate-y-[2px] hover:bg-[#ff8064] hover:shadow-[0_0_30px_rgba(255,111,89,0.45)] overflow-hidden cursor-pointer"
                >
                  <span className="relative z-10 flex items-center">
                    BOOK A FREE CONSULTATION
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="ml-2 transition-transform group-hover:translate-x-1">
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-[#FFB627]/20 transition-colors">
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
              ...
              <div className="flex items-center gap-6 mt-8 pt-4 border-t border-white/10">
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#FFB627]" fill="currentColor" viewBox="0 0 20 20">
                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                  </svg>
                  <span className="text-white/60 text-xs font-mono">4.9/5 Rating</span>
                </div>
                <div className="w-px h-4 bg-white/20" />
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#2FA5C4]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
                  <span className="text-white/60 text-xs font-mono">24hr Response</span>
                </div>
                <div className="w-px h-4 bg-white/20" />
                <div className="flex items-center gap-2">
                  <svg className="w-4 h-4 text-[#4CAF6D]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                  </svg>
                  <span className="text-white/60 text-xs font-mono">100% Confidential</span>
                </div>
        ...
        {/* Footer */}
        <footer className="bg-white/80 backdrop-blur-sm border-t-4 border-[#FFB627]/20 relative pb-8 pt-16 md:pt-20 z-30">
          <div className="max-w-[90rem] mx-auto px-[clamp(1.5rem,5vw,5rem)] flex flex-col lg:flex-row justify-between gap-12 lg:gap-16 border-b border-slate-200 pb-12 lg:pb-16">
            <div className="flex flex-col justify-between max-w-xs">
              <img src="/logo.png" alt="Neuro Nest Counseling Center Logo" className="md:w-40 w-32 h-auto object-contain mb-8" />
              <div className="font-mono text-xs font-semibold text-slate-500 leading-[1.8] tracking-widest">
                NEURO NEST COUNSELING CENTER
                <br />
                RCI REGISTERED PSYCHOLOGIST
                <br />
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-10 md:gap-24 w-full lg:w-auto">
              <div>
                <h5 className="font-mono text-xs font-bold text-[#E63950] tracking-[0.2em] mb-6 uppercase">
                  Services
                </h5>
                <ul className="flex flex-col gap-4 font-mono text-sm font-medium text-slate-500">
                  <li><button onClick={openLeadPopup} className="hover:text-[#E63950] transition-colors block cursor-pointer">Remedial Therapy</button></li>
                  <li><button onClick={openLeadPopup} className="hover:text-[#E63950] transition-colors block cursor-pointer">ABA Therapy</button></li>
                  <li><button onClick={openLeadPopup} className="hover:text-[#E63950] transition-colors block cursor-pointer">Behaviour Therapy</button></li>
                </ul>
              </div>
              <div>
                <h5 className="font-mono text-xs font-bold text-[#2FA5C4] tracking-[0.2em] mb-6 uppercase">
                  Practice
                </h5>
                <ul className="flex flex-col gap-4 font-mono text-sm font-medium text-slate-500">
                  <li><a href="#about" className="hover:text-[#2FA5C4] transition-colors block">Our Approach</a></li>
                  <li><a href="#about" className="hover:text-[#2FA5C4] transition-colors block">About Rama Amte</a></li>
                  <li><a href="#" className="hover:text-[#2FA5C4] transition-colors block">Press Room</a></li>
                </ul>
              </div>
              <div className="col-span-2 md:col-span-1">
                <h5 className="font-mono text-xs font-bold text-[#4CAF6D] tracking-[0.2em] mb-6 uppercase">
                  Connect
                </h5>
                <ul className="flex flex-col gap-4 font-mono text-sm font-medium text-slate-500">
                  <li><a href="#" className="hover:text-[#4CAF6D] transition-colors block">Instagram</a></li>
                  <li><a href="#" className="hover:text-[#4CAF6D] transition-colors block">LinkedIn</a></li>
                  <li>
                    <a href="#" className="hover:text-[#4CAF6D] transition-colors flex items-center gap-2">
                      Availability
                      <div className="w-1.5 h-1.5 bg-[#10B981] rounded-full animate-pulse" />
                    </a>
                  </li>
          ...
          <div className="w-full flex justify-center mt-6 md:mt-8">
            <span className="font-mono text-xs font-semibold text-slate-400 tracking-widest uppercase text-center px-4">
              © 2024 NEURO NEST COUNSELING CENTER. ALL RIGHTS RESERVED.
            </span>
          </div>
        </footer>
      ...
      <style jsx global>{`
        @import url('https://fonts.googleapis.com/css2?family=Baloo+2:wght@400..800&family=Quicksand:wght@400..700&display=swap');

        .font-display {
          font-family: 'Baloo 2', 'Fredoka', ui-rounded, sans-serif !important;
        }
        .font-sans, body {
        ...
        @keyframes float2 {
          0%, 100% { transform: translateY(0) scale(1); }
          50% { transform: translateY(16px) scale(0.9); }
        }
        ...
        .codepen-button::before {
          ...
          width: 400%;
          height: 100%;
          background: linear-gradient(115deg, #FFB627, #FF6F59, #E63950, #2FA5C4, #4CAF6D, #FFB627);
          background-size: 25% 100%;
          animation: border-shift 1.4s linear infinite;
        }
        .codepen-button span {
          position: relative;
          display: flex;
